...
const PrivacyPolicy = () => (
  ...
  <div className="px-8 py-20  max-w-5xl mx-auto space-y-8">
    <h1 className="text-3xl font-bold text-[#0B2A4A]">Privacy Policy</h1>
    ...
    <section className="space-y-4">
      <h2 className="text-2xl font-semibold text-[#0B2A4A]">Information We Collect</h2>
      <p className="text-gray-600 leading-relaxed">
    ...
    <section className="space-y-4">
      <h2 className="text-2xl font-semibold text-[#0B2A4A]">How We Use Your Information</h2>
    ...
    <section className="space-y-4">
      <h2 className="text-2xl font-semibold text-[#0B2A4A]">Information Sharing</h2>
      <p className="text-gray-600 leading-relaxed">
    ...
    <section className="space-y-4">
      <h2 className="text-2xl font-semibold text-[#0B2A4A]">Security</h2>
      <p className="text-gray-600 leading-relaxed">
    ...
    <section className="space-y-4">
      <h2 className="text-2xl font-semibold text-[#0B2A4A]">Policy Updates</h2>
      <p className="text-gray-600 leading-relaxed">
